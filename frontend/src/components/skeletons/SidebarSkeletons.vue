<template>
    <aside class="h-full w-20 lg:w-72 border-r border-base-300 flex flex-col transition-all duration-200">
        ...
        <div class="overflow-y-auto w-full py-3">
            <div v-for="ids in skeletonContacts" :key="ids" class="w-full p-3 flex items-center gap-3">
                <!-- Avatar skeleton -->
                <div class="relative mx-auto lg:mx-0">
                    <div class="skeleton size-12 rounded-full"></div>
                </div>
                <!-- User info skeleton - ony visible on larger screens -->
